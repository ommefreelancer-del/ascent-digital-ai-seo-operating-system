...
// assigned to the Technical SEO Agent?" against BossAgent's public
...
export const TECHNICAL_SEO_AGENT_ID = "technical-seo-agent";

/** True if `decision` was auto-assigned (or human-confirmed) to this agent. */
export function isTechnicalSeoAssignment(decision: RoutingDecision): boolean {
  return decision.status === "assigned" && decision.assignedAgentId === TECHNICAL_SEO_AGENT_ID;
}
