...
// assigned to the Business Development Agent?" against BossAgent's public
...
export const BUSINESS_DEVELOPMENT_AGENT_ID = "business-development-agent";

/** True if `decision` was auto-assigned (or human-confirmed) to this agent. */
export function isBusinessDevelopmentAssignment(decision: RoutingDecision): boolean {
  return decision.status === "assigned" && decision.assignedAgentId === BUSINESS_DEVELOPMENT_AGENT_ID;
}
